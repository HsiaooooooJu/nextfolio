...
type MoonType = React.SVGProps<SVGPathElement> & {
    color?: string
    size?: string
    stroke?: string
    isFilled?: boolean
...
export function Egg({ size = 'size-15' }: { size: string }) {
    return (
        <div className={size}>
            <svg
                className='h-full w-full'
    ...
    return (
        <div className={size}>
            <svg
                ...
                className={cx('h-full w-full', hover)}
...
export function CakeIcon({ width = 'w-6' }: { width: string }) {
    return (
        <div className={width}>
            <svg
                xmlns='http://www.w3.org/2000/svg'
                width='72'
                height='24'
                className='aspect-[1/3] h-full w-full'
                viewBox='0 0 112 32'
                fill='none'
            >
